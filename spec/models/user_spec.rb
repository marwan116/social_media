...
describe User do
  ...
  describe "when email is of a valid format" do
  ...
  describe "when email is of an invalid format" do
  		it "should not be valid" do
		addresses=%w[user@foo,com, user_at_foo.org, example.user@foo., foo@bar_bar.com,foo@a+b.com]
